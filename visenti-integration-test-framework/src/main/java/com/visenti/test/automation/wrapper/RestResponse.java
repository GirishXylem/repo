...
public class RestResponse {
    ...
    public RestResponse hamcrestResponseBodyValidation(String validationType, String elementName, String expectedResults) {
        switch (validationType) {
            ...
            case "containsString":
                ...
                break;
            case "isEmptyString":
                response.then().log().all().body(is(emptyString())).log().ifValidationFails();
                break;
            default:
                break;
        }
    ...
    public Map<String,Object> getJsonWithMap(String jsonPathExpression)
    {
    	JsonPath jsonPath=new JsonPath(getAPIResponseAsString());
    	return jsonPath.getMap(jsonPathExpression);
    }
    /**
  ...
  * */
    ...
    */
    ...
    public List<Object>getListOfElements(String jsonPathExpression)
    {
    	JsonPath jsonPath = new JsonPath((getAPIResponseAsString()));
        return jsonPath.getList(jsonPathExpression);
    }
